...
const Loading = ({ text }) => {
  return (
    <div className="preloader">
      ...
      <p className="preloader__msg">{text}</p>
    </div>

    <svg className="cart_loading" role="img" aria-label="Shopping cart line animation" viewBox="0 0 128 128" width="128px" height="128px" xmlns="http://www.w3.org/2000/svg">
